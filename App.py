...
positions = get(DATA_API + “/positions”, params={“user”: wallet, “sizeThreshold”: 0})
if positions:
...
activity = get(DATA_API + “/activity”, params={“user”: wallet, “limit”: 20})
if activity:
rows = []
for a in activity:
...
markets = get(GAMMA_API + “/markets”, params={“active”: “true”, “closed”: “false”, “limit”: 10, “order”: “volume24hr”, “ascending”: “false”})
